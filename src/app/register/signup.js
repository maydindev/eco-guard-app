        ...
        <div className="flex justify-center">
          ...
          <div className="bg-black/65 p-8 rounded-2xl shadow-lg backdrop-blur-sm w-96 mt-8 relative">
            ...
            <div className="mb-4">
              <div className="flex items-center border-2 rounded-md px-3 py-2 mt-1">
                <span className="text-white pr-2">
                  <img src="/iconperson.png" alt="Person Figure" className="w-3 h-3" />
                </span>
                <input
                  type="text"
            ...
            <div className="mb-4">
              <div className="flex items-center border-2 rounded-md px-3 py-2 mt-1">
                <span className="text-white pr-2">
                  <img src="/iconmail.png" alt="Mail Figure" className="w-3 h-3" />
                </span>
                <input
                  type="text"
                  className="bg-transparent flex-1 outline-none text-white"
            ...
            <div className="mb-4">
              <div className="flex items-center border-2 rounded-md px-3 py-2 mt-1">
                <span className="text-white pr-2">
                  <img src="/iconphone.png" alt="Mail Figure" className="w-3 h-3" />
                </span>
                <input
                  type="text"
                  className="bg-transparent flex-1 outline-none text-white"
            ...
            <div className="mb-4">
              <div className="flex items-center border-2 rounded-md px-3 py-2 mt-1">
                ...
                <span className="text-gray-400 cursor-pointer">
                  <img src="/iconeye.png" alt="Eye Figure" className="w-6 h-4" />
                </span>
              </div>
            </div>

            <div className="mb-20 flex items-center text-sm text-white">
              <input type="checkbox" className="mr-2 mb-4 appearance-none w-3 h-3 ml-4 border border-white  bg-transparent checked:bg-blue-500 checked:border-blue-500 focus:ring-2 focus:ring-blue-300" />
              <span>
                I agree{" "}
            ...
            <div className="flex flex-col justify-center mx-6 mb-10 ">
              <button className="w-full bg-white text-blue-600 py-2 rounded-md font-semibold hover:bg-blue-700 transition">
              Sign Up
              </button>
            </div>

            <img src="/person.png" alt="Human Figure" className="w-100 h-80 absolute bottom-[-10px] left-[230px] right-[10px]" />
