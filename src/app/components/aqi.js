  ...
  return (
    <div className="flex flex-col w-[911px] justify-betwen items-between /*border border-red-500*/">
      ...
      <div className="flex my-3 justify-between">
        ...
        <AqiTemperatureHumidity title={"Temperature"} unit= {airTemperature.unit} unitPerValue={airTemperature.unitPerValue} chart={airTemperature.chart}/>

        <AqiTemperatureHumidity title={"Humidity"} unit= {humidity.unit} unitPerValue={humidity.unitPerValue} chart={humidity.chart}/>
      </div>

      <div className="flex my-3 justify-between">
        <AqiPm25Co2 title={"CO2"} current={co2.current} condition={co2.condition} chart={co2.chart}/>
